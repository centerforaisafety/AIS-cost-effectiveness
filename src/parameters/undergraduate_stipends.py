...
params_build_cost_and_participants = {
    # Cost
    "target_budget": 50 * K,
    "fixed_hours_labor": sq.to(1, 100),
    "average_wage": 50,
    "sd_hours_labor": 30,
    "fixed_cost_other": sq.to(300, 1 * K),
    "sd_variable_cost_students": 1,
    "split_variable_cost_students": 0.95,
    # Number of people
    "n_student_undergrad_scaling_parameter_gamma": 0,
    "n_student_undergrad_scaling_parameter_slope": (1 / (2 * K)),
...
additional_params_build_pipeline_and_equivalence = {
    "p_pursue_ais": sq.beta(0.99 * 300, (1 - 0.99) * 300),  # mean 0.24
    ...
    "p_scientist_given_not_phd": sq.beta(0.03 * 300, (1 - 0.03) * 300),
    "p_engineer_given_not_phd": sq.beta(0.07 * 300, (1 - 0.07) * 300),
...
additional_params_build_pipeline_and_equivalence_cf = {
    "p_pursue_ais": sq.beta(0.5 * 300, (1 - 0.5) * 300),  # mean 0.5
    "p_phd_given_pursue_ais": adb.p_phd_given_pursue_ais,  # mean 0.05
    "p_scientist_given_not_phd": sq.beta(0.02 * 300, (1 - 0.02) * 300),
    "p_engineer_given_not_phd": sq.beta(0.04 * 300, (1 - 0.04) * 300),
}
...
additional_params_build_relevance_and_ability = {
    "research_relevance_student_undergrad_via_phd": 10,
    "research_relevance_multiplier_after_phd_student_undergrad_via_phd": 0.7,
    "research_relevance_during_program_student_undergrad_via_phd": None,
    "research_relevance_student_undergrad_not_via_phd": 10 * 0.7,
    "research_relevance_during_program_student_undergrad_not_via_phd": None,
